...
\begin{center}
    ...
    $|$
    \faLinkedinSquare \hspace{.5pt} \href{https://www.linkedin.com/in/jyunyihuang}{LinkedIn}
    $|$
    \faGithub \hspace{.5pt} \href{https://github.com/jyunyihuang}{GitHub}
    $|$
    \faGlobe \hspace{.5pt} \href{https://jyunyihuang.github.io/mynotes/}{Portfolio}
    $|$
\end{center}
