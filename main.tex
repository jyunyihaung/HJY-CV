...
\begin{center}
    \textbf{\Huge \scshape Jyun-Yi Huang} \\ \vspace{3pt}
    \small
    \faMobile \hspace{.5pt} \href{tel:0933209972}{+886 933 209 972}
    $|$
    \faAt \hspace{.5pt} \href{mailto:jyunyihuang@gmail.com}{jyunyihuang@gmail.com}
    $|$
    \faLinkedinSquare \hspace{.5pt} \href{https://www.linkedin.com/in/jyun-yi-huang-b163047a/}{LinkedIn}
    $|$
    \faGithub \hspace{.5pt} \href{https://github.com/jyunyihaung}{GitHub}
    $|$
    \faGlobe \hspace{.5pt} \href{https://jyunyihaung.github.io/mynotes/}{Portfolio}
    $|$
\end{center}
...
\section{Education}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeEducationHeading
      {Southern Taiwan University of Science and Technology, Master Student — 2013/9-2017/7
